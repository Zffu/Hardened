...
/**
 * <p>The base of a command registrar. Using this registrar system allows for potentially multiple platform registration in the same code.</p>
...
public abstract class CommandRegistrar<K extends Hardened> {
     ...
     */
    public abstract void register(@NotNull Command<?> command);
